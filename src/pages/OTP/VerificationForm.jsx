  ...
  return (
    <Form onSubmit={handleSubmit} className="text-center">
      ...
      <p className="text-muted">
        {otpChannel === "sms" ? (
          <>
            A 6-digit code has been sent via SMS to the number ending in{" "}
            <strong>{maskedData}</strong>.
          </>
        ) : (
          <>
            A 6-digit code has been sent to <strong>{maskedData}</strong>
          </>
        )}
      </p>
...
export default VerificationForm_v2;
